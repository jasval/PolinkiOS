...
//		UISegmentedControl.appearance().setTitleTextAttributes([ NSAttributedString.Key.font: UIFont(name: "Trim-Regular", size: 13.0)!, NSAttributedString.Key.kern: NSNumber(0.3), NSAttributedString.Key.foregroundColor:], for: .normal)
		
		
//		OnboardNavigationBar.appearance().isTranslucent = false
//		OnboardNavigationBar.appearance().shadowImage = UIImage()
